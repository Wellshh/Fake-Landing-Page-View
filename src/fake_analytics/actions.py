...
async def check_proxy_ip(page: Page) -> dict:
        ...
        if response and response.ok:
            ...
            if geo_data.get("status") == "success":
                ...
                locale_map = {
                    ...
                    "SG": "en-SG", "MY": "en-MY", "TH": "th-TH", "MM": "my-MM",
                    "CN": "zh-CN", "DE": "de-DE", "JP": "ja-JP", "IN": "en-IN",
                    "FR": "fr-FR", "ES": "es-ES", "IT": "it-IT", "KR": "ko-KR",
                    "TW": "zh-TW", "BR": "pt-BR", "MX": "es-MX", "NL": "nl-NL",
                    "SE": "sv-SE",
                }
